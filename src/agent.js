...
[
  {
    ...
    "fix": "one concrete actionable fix",
    "context": "where on the page (e.g. Hero section, Navigation bar, Footer)",
    "learnMoreUrl": "pick the single most relevant URL from this list that matches this exact issue type — CTA missing: https://www.nngroup.com/articles/call-to-action-buttons/ | Social proof: https://cxl.com/blog/is-social-proof-really-that-important/ | Navigation: https://www.nngroup.com/articles/navigation-ia-tests/ | Contact/address: https://blog.hubspot.com/marketing/contact-us-page-examples | FAQ: https://blog.hubspot.com/service/faq-page | Pricing: https://cxl.com/blog/pricing-page/ | Urgency: https://cxl.com/blog/urgency/ | Hero/value prop: https://cxl.com/blog/value-proposition-examples-how-to-create/ | General UX: https://www.nngroup.com/articles/ten-usability-heuristics/"
  },
  { "type": "UX Issue", "title": "...", "problem": "...", "targetText": "...", "fix": "...", "context": "...", "learnMoreUrl": "..." },
  { "type": "UX Issue", "title": "...", "problem": "...", "targetText": "...", "fix": "...", "context": "...", "learnMoreUrl": "..." },
  { "type": "UX Issue", "title": "...", "problem": "...", "targetText": "...", "fix": "...", "context": "...", "learnMoreUrl": "..." },
  { "type": "UX Issue", "title": "...", "problem": "...", "targetText": "...", "fix": "...", "context": "...", "learnMoreUrl": "..." },
  {
    ...
    "after": "your improved version",
    "fix": "one sentence: why the new version converts better",
    "learnMoreUrl": "pick best match — Headline: https://copyblogger.com/magnetic-headlines/ | Value prop: https://cxl.com/blog/value-proposition-examples-how-to-create/ | Copywriting formulas: https://copyhackers.com/2016/10/copywriting-formulas/ | AIDA: https://cxl.com/blog/aida-model/ | General copy: https://copyhackers.com/2016/01/website-copy/"
  },
  { "type": "Copy Problem", "title": "...", "problem": "...", "targetText": "...", "before": "...", "after": "...", "fix": "...", "learnMoreUrl": "..." },
  { "type": "Copy Problem", "title": "...", "problem": "...", "targetText": "...", "before": "...", "after": "...", "fix": "...", "learnMoreUrl": "..." },
  { "type": "Copy Problem", "title": "...", "problem": "...", "targetText": "...", "before": "...", "after": "...", "fix": "...", "learnMoreUrl": "..." },
  { "type": "Copy Problem", "title": "...", "problem": "...", "targetText": "...", "before": "...", "after": "...", "fix": "...", "learnMoreUrl": "..." },
  {
    ...
    "after": "improved CTA text",
    "fix": "placement or wording tip",
    "learnMoreUrl": "pick best match — CTA design: https://www.nngroup.com/articles/call-to-action-buttons/ | CTA copy: https://copyhackers.com/2016/10/copywriting-formulas/ | CTA examples: https://unbounce.com/conversion-rate-optimization/call-to-action-examples/"
  },
  { "type": "CTA Issue", "title": "...", "problem": "...", "targetText": "...", "before": "...", "after": "...", "fix": "...", "learnMoreUrl": "..." },
  { "type": "CTA Issue", "title": "...", "problem": "...", "targetText": "...", "before": "...", "after": "...", "fix": "...", "learnMoreUrl": "..." },
  {
    "type": "Mobile Issue",
    "title": "3–5 word title",
    ...
    "targetText": "exact visible text near this issue on the page",
    "fix": "actionable mobile/a11y fix",
    "learnMoreUrl": "pick best match — Viewport meta: https://web.dev/viewport/ | Touch targets: https://web.dev/accessible-tap-targets/ | Alt text: https://www.w3.org/WAI/tutorials/images/decision-tree/ | WCAG: https://www.w3.org/WAI/WCAG21/quickref/ | Mobile UX: https://web.dev/mobile-ux/ | Lazy loading: https://web.dev/lazy-loading-images/"
  },
  { "type": "Mobile Issue", "title": "...", "problem": "...", "targetText": "...", "fix": "...", "learnMoreUrl": "..." },
  { "type": "Mobile Issue", "title": "...", "problem": "...", "targetText": "...", "fix": "...", "learnMoreUrl": "..." },
  {
    "type": "Trust Issue",
    "title": "3–5 word title",
    ...
    "targetText": "exact visible text near this trust issue",
    "fix": "actionable trust-building fix",
    "learnMoreUrl": "pick best match — Social proof: https://cxl.com/blog/is-social-proof-really-that-important/ | HTTPS: https://web.dev/why-https-matters/ | Trust signals: https://www.nngroup.com/articles/trust-and-credibility-guidelines-for-web-design/ | Privacy policy: https://gdpr.eu/privacy-notice/ | Security badges: https://baymard.com/blog/site-seal-trust"
  },
  { "type": "Trust Issue", "title": "...", "problem": "...", "targetText": "...", "fix": "...", "learnMoreUrl": "..." },
  { "type": "Trust Issue", "title": "...", "problem": "...", "targetText": "...", "fix": "...", "learnMoreUrl": "..." },
  {
    "type": "SEO Issue",
    "title": "3–5 word title",
    ...
    "targetText": "exact page text relevant to this SEO issue (title tag content, H1 text, etc.)",
    "fix": "exact actionable fix with tool name where possible",
    "learnMoreUrl": "pick best match — Title tag: https://developers.google.com/search/docs/appearance/title-link | Meta description: https://developers.google.com/search/docs/appearance/snippet | H1/headings: https://developers.google.com/search/docs/appearance/good-titles-snippets | Canonical: https://developers.google.com/search/docs/crawling-indexing/canonicalization | Schema markup: https://developers.google.com/search/docs/appearance/structured-data/intro-structured-data | OG tags: https://ogp.me/ | Broken links: https://search.google.com/search-console/about | Core Web Vitals: https://web.dev/vitals/ | Alt text SEO: https://developers.google.com/search/docs/appearance/google-images"
  },
  { "type": "SEO Issue", "title": "...", "problem": "...", "targetText": "...", "fix": "...", "learnMoreUrl": "..." },
  { "type": "SEO Issue", "title": "...", "problem": "...", "targetText": "...", "fix": "...", "learnMoreUrl": "..." }
]
ISSUES_END
...
8. NEVER invent statistics in "after" copy — use [PLACEHOLDER] for unknown numbers
9. SEO Issues must cite real findings from the TECHNICAL AUDIT section above
10. learnMoreUrl MUST be a real URL from the options listed — pick the ONE most relevant to this specific issue. Never invent a URL.
`;
...
If something is genuinely good, say so. Do not invent criticism to fill a quota.`,
    ...
    issues = issues
      ...
      .map(i => ({
        ...
        before:       (i.before       || "").trim(),
        after:        (i.after        || "").trim(),
        learnMoreUrl: (i.learnMoreUrl || "").trim().slice(0, 300),
      }))
      .filter(i => {
        if (seen.has(i.targetText)) return false;
        seen.add(i.targetText);
